...
<!DOCTYPE HTML>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="nav">
            ...
            <a  class="navbar-brand" href="admin_home.php" style="margin-left:0.4em;margin-right:0.4em">
            ...
            <div class="collapse navbar-collapse" id="navbar-items" style="margin-left:0.4em;margin-right:0.4em">
                <ul class="items navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link active" href="admin_home.php?type='Generic'">Generic</a></li>
                    <li class="nav-item"><a class="nav-link" href="admin_home.php?type='Ayurvedic'">Ayurvedic</a></li>
                    <li class="nav-item"><a class="nav-link" href="admin_home.php?type='Homeopathic'">Homeopathic</a></li>
                    <li class="nav-item"><a class="nav-link" href="admin_home.php?type='Veterinary'">Veterinary</a></li>
